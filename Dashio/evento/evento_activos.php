<?php 
 ...
 $obj= new DbModelo();
 $consulta=$obj->get_tabla("SELECT * FROM tbl_eventos where ID_ESTADO=1;");
                ...
                <table id="tabla_eventos" class="table table-bordered table-hover ">
                 ...
                 <tbody >
                   ...
                   <th scope="row"><?=$i+1?></th>
                    ...
                    <a href="javascript:void(0)"  onclick="get_html(this,'evento/modificar_evento.php?id=<?=$row['ID_EVENTO']?>','Modificar evento');"  title="Editar Evento" class="btn btn-sm btn-info"> <i class="fa fa-edit"></i> </a>
