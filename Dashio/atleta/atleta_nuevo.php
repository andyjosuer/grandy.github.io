...
<form method="POST" id="inscripcion_atleta_nuevo" action="atleta/insertar_atleta_nuevo.php"> 
  <div class= "form-group">
     <center><h3 class="black-text"> INSCRIPCIÓN DE ATLETA NUEVO</h3></center>
    ...
    <div class="form-group col-sm-3" >
      ...
      <input minlength="13" maxlength="13" type="text" class="form-control" placeholder="Numero de Identidad" name="Identidad_atleta" id="Identidad_atleta"  required = "" onkeypress="return valida(event)">  
    </div>

    <div class="form-group col-sm-3" >
      <label for="fecha_atleta" class="control-label">Fecha de nacimiento:</label>
      <input  class="form-control" name="fecha_atleta" id="fecha_atleta" type="date"> <br>
    </div>

    <div class="form-group col-sm-3" >
      <label for="tel_atleta" class="control-label">Teléfono Personal:</label>
      <input  minlength="8" maxlength="10" type="text" class="form-control" placeholder="Teléfono Personal" name="tel_atleta" id="tel_atleta" required ="" onkeypress="return valida(event)">  
    </div>

    <div class="form-group col-sm-3" >
      <label for="correo_atleta" class="control-label">Correo:</label>
      <input  minlength="8" maxlength="100" type="text" class="form-control" placeholder="ejemplo@ejemplo.com" name="correo_atleta" id="correo_atleta" required=""> 
    </div>
         
    <div class="form-group col-sm-3" >
      <label  for="Depto_atleta" class="control-label"> Departamento:</label>                  
      <select class="form-control" name="Depto_atleta" id="Depto_atleta">
        <option value="<?php echo $row['ID_DEPTO']; ?>">Seleccione un departamento</option>
    ...
    <div class="form-group col-sm-3" >  
      ...
      <select class="form-control" name="Ciudad_atleta" id="Ciudad_atleta" >    
        <option value="<?php echo $row['ID_CIUDAD']; ?>">Seleccione una ciudad</option> 
    ...
    <div class="form-group col-sm-3">
      ...
      <input  type="text" class="form-control" placeholder="Peso" name="peso" id="peso"  onkeypress="return validanumeros(event)" >
    </div> 

    <div class="form-group col-sm-3">
      <label class="control-label" for="val-username">Altura (Mts)</label> 
      <input  type="text" class="form-control" placeholder="Altura" name="altura" id="altura" onkeypress="return validanumeros(event)">
    </div>

    <div class="form-group col-sm-3" >
      <label for="Genero_atleta" class="control-label"> Género:</label>                  
      <select class="form-control" name="Genero_atleta" id="Genero_atleta">
        <option value="<?=$row['ID_GENERO']; ?>">  Seleccione un genero </option>
        <?php
    ...
    <div class="form-group col-sm-3" >
      ...
      <select class="form-control" name="categoria" id="categoria">
         <option value="<?php echo $row['NOM_CATEGORIA']; ?>">Seleccione una modalidad</option>
      </select>
    </div>
    ...
    <div class="form-group col-sm-3" >
      ...
      <select class="form-control" name="subcategoria" id="subcategoria" >
        <option value="<?php echo $row['NOM_SUBCATEGORIA']; ?>">Seleccione una categoría</option>
      </select>
    </div>
    ...
    <div class="form-group col-sm-3" >
      ...
      <select class="form-control" name="subcategoria2" id="subcategoria2" >
        <option value="<?php echo $row['ID_SUBCATEGORIA2']; ?>">Seleccione una categoría</option>
    ...
    <div class="form-group col-sm-3" >
      ...
      <select class="form-control" name="Ecivil_atleta" id="Ecivil_atleta">
       <option value="<?php echo $row['ID_EST_CIVIL']; ?>">Seleccione el estado civil</option>
        <?php
    ...
    <div class="form-group col-sm-3" >
      ...
      <select class="form-control" name="Estado" id="Estado" required>
        <option value="<?=$row['NOM_ESTADO']; ?>">  Seleccione el estado</option>            
        <?php
        //Trae el nom_estado
    ...
    <div class="form-group col-sm-3">
      <input type="radio" name="radio" id="club_gim" value="1" onclick="desactivar()">
      <label for="edadminima">Independiente</label>
    </div>

    <div class="form-group col-sm-3">
      <input type="radio" name="radio" id="club_gim" value="1" onclick="activar()">
      <label for="edadminima">Club/Gimnasio</label>   
    </div> 

    <div class="form-group col-sm-3">
     <input   type="text" class="form-control col-sm-3" placeholder="Nombre del Club/Gimnasio" name="Gimnasio_atleta" id="Gimnasio_atleta">
    </div>
    ...
    <div class="form-group col-sm-10">
      ...
      <textarea  class="form-control" id="direc_atleta" name="direc_atleta" rows="2"  ></textarea>
    </div>
