...
<head>
<script type="text/javascript" src ="subcategoria/maxmin.js"></script>
</head>
          ...
          <br><br>   
                     <div class="container ">
                          <div class= "form-group col-sm-5">
                              <label   for="nombresubcate"> Nombre de Modalidad</label>
                           ...
                           <div class="form-group col-sm-5">
                                       <label class="control-label"  for="nombrecate">Nombre de Categoria</label>
                           ...
                           <div class="form-group col-sm-3">
                              ...
                              <input type="text" class="form-control" disabled="disabled"  onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="input-block-level" placeholder="Edad Minima" id="edadminima" name="edadminima"  onkeypress="return validanumeros(event)" >                                                                   
                                <br>
                               <input type="text" class="form-control" disabled="disabled"  onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="input-block-level" placeholder="Edad Maxima" id="edadmaxima" name="edadmaxima"  onkeypress="return validanumeros(event)" > <span class="validacion"></span>                                                               
