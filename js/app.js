	function load(page){
		...
		$('#dataUpdate').on('show.bs.modal', function (event) {
		  ...
		  var codigo = button.data('codigo') // Extraer la información de atributos de datos
            ...
            var pwd = button.data('pwd1') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar Usuario: '+codigo)
		  modal.find('.modal-body #id').val(id)
		  modal.find('.modal-body #codigo').val(codigo)
              modal.find('.modal-body #usuario').val(usuario)
                        modal.find('.modal-body #pwd1').val(pwd)
