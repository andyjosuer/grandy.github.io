...
if (isset($_POST["Guardar"])) { 
	...
	//	echo '<script>alert("Persona ingresada")</script>';
	...
	if (mysqli_query($mysqli, "INSERT INTO tbl_atletas(ID_PERSONA, TEL_EMERGENCIA,NOM_RESPON) VALUES ('$Per','$tel_em','$responsable')")) {
		//echo '<script>alert("atleta ingresado")</script>';
	}
	...
	if (mysqli_query($mysqli,"INSERT INTO tbl_inscripcion(ID_ATLETA,ID_EVENTO,NOM_GYM) VALUES ('$atleta','$evento','$Gimnasio')")) {
	...
	if (mysqli_query($mysqli,"INSERT INTO tbl_inscripcion_subcategoria(ID_INSCRIPCION,ID_SUBCATEGORIA) VALUES ('$inscrip','$subcategoria')")) {
		//echo '<script>alert("inscripcion cate")</script>';
	}
	...
	echo "<script>jQuery(function(){swal('¡Datos ingresados!', 'Correctamente', 'success');});</script>";
